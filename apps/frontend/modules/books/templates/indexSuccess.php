...
<table align='center' rules=none>
    <tr>
      <td colspan=7><div id='head'><h3>Последние 20 ищущихся книг</h3></div></td>
    </tr>
    <tr align='center'>
    ...
    <tr>
      <td align='center' bgcolor=<?php echo $a ?>><div id='td'><a href="<?php echo url_for('books/show?id='.$books->getId()) ?>"><div id='button1'>Открыть</div></a></div></td>
