CREATE TABLE books (id INT AUTO_INCREMENT, author VARCHAR(100) NOT NULL, name VARCHAR(100) NOT NULL, status VARCHAR(10) NOT NULL, person_id INT NOT NULL, code VARCHAR(5), date_of DATE, INDEX status_idx (status), INDEX person_id_idx (person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = INNODB;
