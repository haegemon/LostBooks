...
abstract class BaseBooksForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'person_mail' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('person'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'status'      => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('bookstypes'), 'required' => false)),
      'person_mail' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('person'))),
